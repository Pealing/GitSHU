 ...
 */
@Controller
public class Inbox extends ActionVariableSupport {
    private final MailService mailService;

    @Autowired
    public Inbox(MailService mailService) {
        this.mailService = mailService;
    }

    public String execute() {
        String username = (String) httpSession.get("username");
        List<MailEntity> mailEntityList = mailService.getInbox(username);
        httpServletRequest.setAttribute("inbox", mailEntityList);
        return SUCCESS;
    }
}
